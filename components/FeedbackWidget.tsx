...
const FeedbackWidget = () => {
  ...
  return (
    <div className="fixed right-4 bottom-4 z-50 md:right-6 md:bottom-6 flex flex-col items-end gap-3">
      ...
      {/* FAB */}
      {/* flex  items-center justify-center rounded-fullbg-accent shadow-lg shadow-accent/30 transition-shadow h-12 w-12 hover:shadow-xl text-accent-foreground  */}
      <motion.button
        ...
        <AnimatePresence mode="wait">
          {open ? (
            ...
            >
              ...
              {/* <Image src ="https://res.cloudinary.com/dsfems7vy/image/upload/v1783191213/Wavey_Birdie_dc2ddx.gif" width = {75} height = {75} alt="Wavey Birdie" /> */}
            </motion.span>
          )}
        </AnimatePresence>
      </motion.button>
